...
sys.path.insert(0,"V:\\jpasillasdiaz\Python\envs\\image_recognition\Lib\site-packages") 
...
#To run this script : e.g Data_Analysis_ISIS.py --username jpasillasdiaz --isis 1 (for ISIS batch 2 run by jpasillas)
#Script defaults to ISIS Batch 2 

parser = OptionParser()

parser.add_option('-u', '--username', dest='username', 
        default='jpasillasdiaz', type='str', 
...
while stop_condition == False:
    ...
    img_crop_path = 'template.png'    
    df_read = process_images(img_fns, img_crop_path, minimum_correlation=0.5)
