...
def process_subdirectory(subdir_path, regex_images, output_path):
    ...
    df_processed.to_csv(f"{output_path}iono-processed-20231221-01.csv")
...
batch_path = 'C:/Python_Projects/Image_Analisys/Alouette_extract-master/Alouette-1/ISIS/' # it should has two level ▼ 
# dir/subdir before providing the image
temp_dir = 'C:/Python_Projects/Image_Analisys/Alouette_extract-master/Alouette-1/isis_quality_analysis/'
output_path ="C:/Python_Projects/Image_Analisys/Alouette_extract-master/Alouette-1/ISIS_output/"
...
# to make csv file name dynamic
today_date = datetime.datetime.now().strftime("%Y%m%d")
sequence_number = 1
while os.path.exists(f"{output_path}user-accuracy-test-{today_date}-{sequence_number:02}.csv"):
    sequence_number += 1
filename = f"user-accuracy-test-{today_date}-{sequence_number:02}.csv"

df_user.to_csv(os.path.join(output_path, filename))
