...
def read_image(image_path, plotting=False, just_digits=False):
    try: 
        ...
        # cut image to just include bottom 30% of pixels
        cropped_height = height*0.3

        # cut image to just include bottom 20% of pixels  ## edit made by Jeysh - check with Ashley
       ...
       # print('max digits distance:', max_d)
        print('total digits count:', digit_count)
